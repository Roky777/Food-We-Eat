...
export function renderGameUi(state, level) {
  ...
  if (state.screen === "complete") {
    ...
    screen.setAttribute("aria-label", "Food We Eat Master certificate");
    ...
    card.innerHTML = `
      ...
      <p class="game-certificate__eyebrow">Food Factory Champion</p>
      <h2>Food Sorting <em>Master!</em></h2>
      ...
      <div class="game-certificate__stamps" aria-label="Skills mastered">
        <div class="game-certificate__stamp game-certificate__stamp--shapes"><i aria-hidden="true">🌿</i><strong>Plants</strong></div>
        <div class="game-certificate__stamp game-certificate__stamp--families"><i aria-hidden="true">🥕</i><strong>Parts</strong></div>
        <div class="game-certificate__stamp game-certificate__stamp--motion"><i aria-hidden="true">🥛</i><strong>Sources</strong></div>
      </div>
  ...
  if (state.completedLevel) {
    ...
    success.innerHTML = `
      <img class="success-screen__background" src="assets/backgrounds/food_we_eat_bg_blurred_matching.webp" alt="" />
  ...
  if (state.paused) {
    ...
    pause.innerHTML = `
      <img class="pause-screen__background" src="assets/backgrounds/food_we_eat_bg_blurred_matching.webp" alt="" />
